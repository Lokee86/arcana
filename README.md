...
fact objects remain readable during migration. Language adapters now live in the co-located [`grimoire/lexicon`](https://github.com/Lokee86/grimoire/tree/main/lexicon) component; Arcana does not own language parsers.
...
Arcana is available under the [PolyForm Shield License 1.0.0](LICENSE.md). Competing products and services require a separate commercial license. See [LICENSING.md](LICENSING.md).
